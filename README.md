...
| Coulomb-Skyrme | $U \in \textup{SU}(2)$, $A_0 \in \mathbb{R}$ | $\mathcal{L}_{\textup{Cou}}[U,A_0] = \frac{F_\pi^2}{16\hbar}\textup{Tr}(L_\mu L^\mu) + \frac{\hbar}{32g^2} \textup{Tr}\left([L_\mu,L_\nu][L^\mu,L^\nu]\right) - \frac{F_\pi^2m_\pi^2}{8\hbar^3} \textup{Tr}(\textup{Id}_2-U) + \frac{1}{2\hbar}\|\bm{\nabla}A_0\|^2 - \frac{e}{2}A_0 B^0[U]$ |
