...
|--------|--------|--------|
| Berger-Skyrme | $U \in \textup{SU}(2)$ | $\mathcal{L}_{\textup{Ber}}[U] = \frac{F_{\pi}^2}{16\hbar}\textup{Tr}(L_{\mu} L^{\mu}) + \frac{\hbar}{32g^2}\textup{Tr}\left([L_{\mu},L_{\nu}][L^{\mu},L^{\nu}]\right) - \frac{F_{\pi}^2m_{\pi}^2}{8\hbar^3}\textup{Tr}(\textup{Id}_2-U) - (\alpha^2-1) \left(\frac{F_{\pi}^2}{8\hbar}L_{\mu}^3L^{3\mu} + \frac{\hbar}{16g^2}\Omega_{\mu\nu}^3\Omega^{3\mu\nu} \right)$ |
| Coulomb-Skyrme | $U \in \textup{SU}(2)$, $A_{0} \in \mathbb{R}$ | $\mathcal{L}_{\textup{Cou}}[U,A_{0}] = \frac{F_{\pi}^2}{16\hbar}\textup{Tr}(L_{\mu} L^{\mu}) + \frac{\hbar}{32g^2} \textup{Tr}\left([L_{\mu},L_{\nu}][L^{\mu},L^{\nu}]\right) - \frac{F_{\pi}^2m_{\pi}^2}{8\hbar^3} \textup{Tr}(\textup{Id}_2-U) + \frac{1}{2\hbar}\|\bm{\nabla}A_{0}\|^2 - \frac{e}{2}A_{0} B^{0}[U]$ |
| Lightly Bound Skyrme | $U \in \textup{SU}(2)$ | $\mathcal{L}_{\textup{Lig}}[U] = (1-\alpha)\left(\frac{F_{\pi}^2}{16\hbar}\textup{Tr}(L_{\mu} L^{\mu}) - \frac{F_{\pi}^2m_{\pi}^2}{8\hbar^3}\textup{Tr}(\textup{Id}_2-U) \right) + \frac{\hbar}{32g^2}\textup{Tr}\left([L_{\mu},L_{\nu}][L^{\mu},L^{\nu}]\right) - \frac{\alpha F_{\pi}^4 g^2}{512\hbar^3(1-\alpha)^2} \textup{Tr}(\textup{Id}_2-U)^4$ |
| Nuclear Skyrme | $U \in \textup{SU}(2)$ | $\mathcal{L}_{\textup{Sk}}[U] = \frac{F_{\pi}^2}{16\hbar} \textup{Tr}(L_{\mu} L^{\mu}) + \frac{\hbar}{32g^2} \textup{Tr}\left( \left[L_{\mu}, L_{\nu}\right] \left[L^{\mu}, L^{\nu} \right] \right) - \frac{F_{\pi}^2 m_{\pi}^2}{8\hbar^3} \textup{Tr}(\textup{Id}_2 - U)$ |
| $\omega$-Skyrme | $U \in \textup{SU}(2)$, $\omega \in \mathbb{R}$ | $\mathcal{L}_{\omega}[U,\omega] = \frac{F_{\pi}^2}{16\hbar}\,\textup{Tr}(L_{\mu} L^{\mu}) + \frac{F_{\pi}^2 m_{\pi}^2}{8\hbar^3}\,\textup{Tr}(U-\textup{Id}_2) + \frac{1}{2\hbar}\|\bm{\nabla}\omega\|^2 + \frac{m_{\omega}^2}{2\hbar^3}\omega^2 + \beta_{\omega} \omega B^{0}[U]$ |
| $\rho$-Skyrme | $U \in \textup{SU}(2)$, $R_{\mu} \in \mathfrak{su}(2)$ | $\mathcal{L}_{\rho}[U,R_{\mu}] = \frac{F_{\pi}^2}{16\hbar} \textup{Tr}(L_{\mu} L^{\mu}) + \frac{\hbar}{32g^2} \textup{Tr}\left( [L_{\mu}, L_{\nu}] [L^{\mu}, L^{\nu}] \right) -\frac{F_{\pi}^2 m_{\pi}^2}{8\hbar^3} \textup{Tr}\left( \textup{Id}_2 - U \right) -\frac{m_{\rho}^2}{4\hbar^3}\textup{Tr}\left(R_{\mu}^\dagger R^{\mu}\right) - \frac{1}{8\hbar} \textup{Tr}\left(R_{\mu\nu}^\dagger R^{\mu\nu}\right) + \frac{1}{2}\alpha\textup{Tr}\left( R_{\mu\nu}[L^{\mu}, L^{\nu}] \right)$ |
