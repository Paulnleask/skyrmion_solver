...
<h4 align="center">
GPU-native finite-difference solver for Skyrmions and baryonic solitons in three-dimensional nonlinear field theories, with Numba CUDA and CUDA–OpenGL rendering.
</h4>
...
- **cuda-python** for CUDA–OpenGL interoperability
...
Shown below is a $B=8$ dodecahedral Skyrmion generated using `skyrmion_solver`.

<p align="center">
  <img src="https://raw.githubusercontent.com/Paulnleask/skyrmion_solver/main/skyrmion_solver/assets/Nucelar_B8.png" width="800">
</p>
...
The framework is designed so that additional variants can be introduced by implementing a new theory module and registering it with the theory loader, without changing the numerical core.

---

## Features

- GPU-native finite-difference solver for three-dimensional nonlinear field theories
...
- arrested Newton flow and related minimization routines
- simulation driver
...
Given a discrete energy $E_h[\phi]$, the solver evolves the fields using explicit GPU kernel updates.
