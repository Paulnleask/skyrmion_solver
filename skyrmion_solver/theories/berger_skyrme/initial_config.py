"""
Initial condition and ansatz CUDA kernels for berger_skyrme simulations.
...
from skyrmion_solver.theories.berger_skyrme.kernels import compute_norm_skyrme_field
