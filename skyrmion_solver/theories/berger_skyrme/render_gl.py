...
Purpose
-------
Provide the Berger Skyrme CUDA/OpenGL ray-marching renderer that keeps the visualization volume on the GPU.

Usage
-----
Use ``GLRenderer`` to render the nuclear Skyrme simulation interactively.
...
from skyrmion_solver.theories.berger_skyrme.observables import compute_skyrmion_number

DISPLAY_ENERGY_SINGLE = 1
DISPLAY_ENERGY_RUNGE = 2

DISPLAY_TITLES = {
    DISPLAY_ENERGY_SINGLE: "Berger Skyrme: Energy density",
    DISPLAY_ENERGY_RUNGE: "Berger Skyrme: Energy density (Runge)",
}
...
class GLRenderer:
    ...
    def __init__(self, width: int, height: int, depth: int, title: str = "berger_skyrme (ray-march)") -> None:
        """
    ...
    def _update_window_title(self) -> None:
        ...
        """
        self.backend.set_window_title(DISPLAY_TITLES.get(self.display_mode, "berger_skyrme"))
