"""
Berger Skyrme theory package registration and user facing theory description.

Examples
--------
Use ``load_theory("Berger Skyrme model")`` to load the theory package.
...
THEORY_SPEC = TheorySpec(
    name="Berger Skyrme model",
    aliases=("Berger Skyrme", "Squashed sphere Skyrme", "Berger skyrmions"),
    import_path="skyrmion_solver.theories.berger_skyrme",
    description="Skyrmions in the 3D Berger-Skyrme model, with the standard pion mass potential.",
    version="1.0"
)
...
def _print_metadata() -> None:
    """
    Print the registry metadata for the Berger-Skyrme theory.
...
def _print_submodules() -> None:
    """
    Print the main Berger-Skyrme submodules.
...
def _print_parameter_information() -> None:
    """
    Print parameter information for the Berger-Skyrme theory.
...
def _print_notes() -> None:
    """
    Print a short summary of the Berger-Skyrme theory package.
    ...
    print("This theory package provides the Berger-Skyrme model in two spatial dimensions.")
...
def _print_instructions() -> None:
    """
    Print additional usage instructions for the Berger-Skyrme theory.
...
def describe() -> None:
    """
    Print a structured description of the Berger-Skyrme theory.
    ...
    Examples
    --------
    Use ``theory.describe()`` to print the Berger-Skyrme theory description.
    """
    _print_metadata()
    _print_submodules()
    _print_notes()
