"""
Initial condition and ansatz CUDA kernels for lightly_bound_skyrme simulations.
...
from skyrmion_solver.theories.lightly_bound_skyrme.kernels import compute_norm_skyrme_field
