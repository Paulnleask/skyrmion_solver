"""
Lightly bound Skyrme theory specific output bundle.

Examples
--------
Use ``output_data_bundle`` to export the lightly bound Skyrme simulation outputs for plotting.
"""
...
def output_data_bundle(
    ...
    """
    Write the lightly bound Skyrme output data bundle.
