"""
Lightly bound Skyrme theory package registration and user facing theory description.

Examples
--------
Use ``load_theory("Lightly bound Skyrme model")`` to load the theory package.
...
THEORY_SPEC = TheorySpec(
    name="Lightly bound Skyrme model",
    aliases=("Lightly bound Skyrme", "Loosely bound Skyrme", "Loosely bound Skyrme model"),
    import_path="skyrmion_solver.theories.lightly_bound_skyrme",
    description="Skyrmions in the lightly bound Skyrme model.",
    version="1.0"
)
...
def _print_metadata() -> None:
    """
    Print the registry metadata for the lightly bound Skyrme theory.
...
def _print_submodules() -> None:
    """
    Print the main lightly bound Skyrme submodules.
...
def _print_parameter_information() -> None:
    """
    Print parameter information for the lightly bound Skyrme theory.
...
def _print_notes() -> None:
    """
    Print a short summary of the lightly bound Skyrme theory package.
    ...
    print("This theory package provides the lightly bound Skyrme model in two spatial dimensions.")
...
def _print_instructions() -> None:
    """
    Print additional usage instructions for the lightly bound Skyrme theory.
...
def describe() -> None:
    """
    Print a structured description of the lightly bound Skyrme theory.
    ...
    Examples
    --------
    Use ``theory.describe()`` to print the lightly bound Skyrme theory description.
    """
    _print_metadata()
    _print_submodules()
    _print_notes()
