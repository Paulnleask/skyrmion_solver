...
THEORY_SPEC = TheorySpec(
    name="Rho-Skyrme model",
    aliases=("Rho-Skyrme", "Rho-skyrmions", "Skyrmions with rho mesons"),
    import_path="skyrmion_solver.theories.rho_skyrme",
    description="Skyrmions in the 3D Skyrme model coupled to rho-mesons, with the standard pion mass potential.",
    version="1.0"
)
