"""
Nuclear Skyrme theory specific output bundle.

Examples
--------
Use ``output_data_bundle`` to export the nuclear Skyrme simulation outputs for plotting.
"""
...
def output_data_bundle(
    ...
    """
    Write the nuclear Skyrme output data bundle.
    ...
    bundle_spec = [
        ...
        ("Field", 8, "Rho_2_2.dat"),
        ("Field", 9, "Rho_2_3.dat"),
        ("Field", 10, "Rho_3_1.dat"),
        ("Field", 11, "Rho_3_2.dat"),
        ("Field", 12, "Rho_3_3.dat"),
