"""
Coulomb Skyrme theory package registration and user facing theory description.

Examples
--------
Use ``load_theory("Coulomb-Skyrme model")`` to load the theory package.
...
THEORY_SPEC = TheorySpec(
    name="Coulomb-Skyrme model",
    aliases=("Coulomb Skyrme", "Maxwell Skyrme"),
    import_path="skyrmion_solver.theories.coulomb_skyrme",
    description="Coulomb backreaction in the 3D nuclear Skyrme model, with the standard pion mass potential.",
    version="1.0"
)
...
def _print_metadata() -> None:
    """
    Print the registry metadata for the Coulomb Skyrme theory.
...
def _print_submodules() -> None:
    """
    Print the main Coulomb Skyrme submodules.
...
def _print_parameter_information() -> None:
    """
    Print parameter information for the Coulomb Skyrme theory.
...
def _print_notes() -> None:
    """
    Print a short summary of the Coulomb Skyrme theory package.
    ...
    print("This theory package provides the Coulomb-Skyrme model in three spatial dimensions.")
...
def _print_instructions() -> None:
    """
    Print additional usage instructions for the Coulomb Skyrme theory.
...
def describe() -> None:
    """
    Print a structured description of the Coulomb Skyrme theory.
    ...
    Examples
    --------
    Use ``theory.describe()`` to print the Coulomb Skyrme theory description.
    """
    _print_metadata()
    _print_submodules()
    _print_notes()
