"""
Instructions for the Coulomb Skyrme interactive controls.
...
def print_instructions():
    """
    Print the interactive control summary for the Coulomb Skyrme simulation.
    ...
    print(
        ...
        "   Coulomb potential density display:      F3\n"
