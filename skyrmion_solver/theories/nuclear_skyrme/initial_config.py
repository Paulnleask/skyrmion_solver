"""
Initial condition and ansatz CUDA kernels for nuclear_skyrme simulations.
...
from skyrmion_solver.theories.nuclear_skyrme.kernels import compute_norm_skyrme_field
