"""
Omega-Skyrme theory package registration and user facing theory description.

Examples
--------
Use ``load_theory("Omega-Skyrme model")`` to load the theory package.
...
THEORY_SPEC = TheorySpec(
    name="Omega-Skyrme model",
    aliases=("Omega-Skyrme", "Omega-meson model", "Omega-meson Skyrme", "Omega-sigma model"),
    import_path="skyrmion_solver.theories.omega_skyrme",
    description="Solitons in the 3D nonlinear sigma model coupled to an omega-meson.",
    version="1.0"
)
...
def _print_metadata() -> None:
    """
    Print the registry metadata for the omega-Skyrme theory.
...
def _print_submodules() -> None:
    """
    Print the main omega-Skyrme submodules.
...
def _print_parameter_information() -> None:
    """
    Print parameter information for the omega-Skyrme theory.
...
def _print_notes() -> None:
    """
    Print a short summary of the omega-Skyrme theory package.
    ...
    print("This theory package provides the omega-Skyrme model in two spatial dimensions.")
...
def _print_instructions() -> None:
    """
    Print additional usage instructions for the omega-Skyrme theory.
...
def describe() -> None:
    """
    Print a structured description of the omega-Skyrme theory.
    ...
    Examples
    --------
    Use ``theory.describe()`` to print the omega-Skyrme theory description.
    """
    _print_metadata()
    _print_submodules()
    _print_notes()
