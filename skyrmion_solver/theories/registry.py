...
class TheorySpec:
    ...
    Examples
    --------
    Use ``TheorySpec(name="Baby Skyrme model", import_path="skyrmion_solver.theories.baby_skyrme", description="Solver for the baby Skyrme model")`` to define a theory specification.
    """
...
def discover_theories(package: str = "skyrmion_solver.theories") -> None:
    """
